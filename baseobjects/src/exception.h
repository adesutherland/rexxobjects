...
// Description : C++ Header for base exception class
// *************************************************************************
// L I C E N S E
// *************************************************************************
...
#ifndef ro_bo_exception_h
#define ro_bo_exception_h

#include <string>

class BROException : public std::exception
{
 private:
  std::string details;

 public:
  BROException(std::string message);
  BROException();
  ~BROException() throw();
  char* what();
};
